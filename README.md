...
<section class="stats">
  <div class="container">
    <div class="stat-grid">
      <div class="stat"><strong>11th</strong><span>Commerce</span></div>
      <div class="stat"><strong>12th</strong><span>Commerce</span></div>
      <div class="stat"><strong>FY • SY</strong><span>B.Com</span></div>
      <div class="stat"><strong>TY</strong><span>B.Com</span></div>
    </div>
  </div>
</section>
...
<section class="section" id="about">
  <div class="container about">
    <div class="about-visual">
      <img src="assets/academy-brochure.png" alt="Joshi's Commerce Academy brochure">
      <div class="badge">Learn • Understand • Improve • Succeed</div>
    </div>
    <div class="about-copy">
      <div class="kicker">About JCA</div>
      <h2>Where Education Meets Personal Attention.</h2>
      <h3>🎓 Welcome to Joshi’s Commerce Academy!</h3>
      <p><b>“Today’s Children are Tomorrow’s Future.”</b> This belief has been the source of inspiration behind our journey since 2017.</p>
      <p>I am <b>Deepak Joshi</b>, Founder of Joshi’s Commerce Academy. I started this academy with a simple yet powerful vision — to provide quality Commerce education with personal attention, proper guidance and continuous support to every student.</p>
      <p>At JCA, we believe that every child is special and every student has the potential to achieve something great. We don’t just teach chapters — we build concepts, develop understanding, encourage confidence and guide students towards their goals.</p>
      <div class="quote">“Your Future. Our Responsibility.”</div>
      <a class="btn btn-dark" href="#contact">Visit / Contact JCA →</a>
    </div>
  </div>
</section>
...
<section class="section courses" id="courses">
  <div class="container">
    <div class="section-head"><div class="kicker">Courses</div><h2>Commerce Coaching From 11th to TY B.Com</h2><p>Structured learning designed to strengthen concepts, practice regularly and improve performance.</p></div>
    <div class="course-grid">
      <div class="course"><div class="icon">📘</div><div><h3>11th Commerce</h3><p>Build a strong foundation in Commerce.</p></div></div>
      <div class="course"><div class="icon">🎯</div><div><h3>12th Commerce</h3><p>Board-focused preparation and regular tests.</p></div></div>
      <div class="course"><div class="icon">📊</div><div><h3>FY B.Com</h3><p>Clear university-level concepts from the start.</p></div></div>
      <div class="course"><div class="icon">🧮</div><div><h3>SY B.Com</h3><p>Conceptual learning with continuous practice.</p></div></div>
      <div class="course"><div class="icon">🏆</div><div><h3>TY B.Com</h3><p>Exam-oriented preparation and career guidance.</p></div></div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="section-head"><div class="kicker">Subjects</div><h2>Subjects We Teach</h2><p>Focused guidance in core Commerce subjects.</p></div>
    <div class="subject-grid">
      <div class="subject"><div class="icon">🧾</div><h3>Accountancy</h3><p>Concepts, formats, practical problem solving and exam practice.</p></div>
      <div class="subject"><div class="icon">∑</div><h3>Mathematics</h3><p>Step-by-step learning, practice and problem-solving confidence.</p></div>
      <div class="subject"><div class="icon">📈</div><h3>Costing</h3><p>Strong fundamentals with systematic numerical practice.</p></div>
      <div class="subject"><div class="icon">₹</div><h3>Income Tax</h3><p>Clear concepts and practical exam-oriented preparation.</p></div>
    </div>
  </div>
</section>
...
<section class="section" id="features">
  <div class="container">
    <div class="section-head"><div class="kicker">Why Choose JCA?</div><h2>More Than Teaching — Complete Student Support</h2><p>Every feature is designed to help students understand better and progress with confidence.</p></div>
    <div class="feature-grid">
      <div class="feature"><div class="num">01</div><div><h3>Personal Attention</h3><p>Focus on individual strengths, weaknesses and learning needs.</p></div></div>
      <div class="feature"><div class="num">02</div><div><h3>Doubt Sessions</h3><p>Clear doubts and strengthen understanding with dedicated support.</p></div></div>
      <div class="feature"><div class="num">03</div><div><h3>Topic Wise Tests</h3><p>Regular practice to strengthen concepts topic by topic.</p></div></div>
      <div class="feature"><div class="num">04</div><div><h3>Full Portion Tests</h3><p>Complete-syllabus practice to build exam confidence.</p></div></div>
      <div class="feature"><div class="num">05</div><div><h3>Career Guidance</h3><p>Direction and guidance to help students choose the right path.</p></div></div>
      <div class="feature"><div class="num">06</div><div><h3>Banking Classes</h3><p>Banking and government competitive exam guidance for Commerce students.</p></div></div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="highlight">
      <div><div class="kicker" style="color:#ffdc4a">Our Result Journey</div><h2>Strong Results. Stronger Confidence.</h2><p>Joshi’s Commerce Academy has maintained a 100% passing result for 12th Board students from 2017, according to the academy.</p></div>
      <div class="big">100%<small style="display:block;font-size:14px;color:#dbe6ff;font-weight:700">12th Board Passing Result*</small></div>
    </div>
  </div>
</section>
...
<section class="section" id="gallery">
  <div class="container">
    <div class="section-head"><div class="kicker">Gallery</div><h2>JCA in Focus</h2><p>Explore our admission creatives, academy identity and course highlights.</p></div>
    <div class="gallery">
      <button onclick="openModal('assets/logo.jpg')"><img src="assets/logo.jpg" alt="JCA logo"></button>
      <button onclick="openModal('assets/admission-marathi.jpg')"><img src="assets/admission-marathi.jpg" alt="JCA Marathi admission poster"></button>
      <button onclick="openModal('assets/admission-open.jpg')"><img src="assets/admission-open.jpg" alt="JCA admission open poster"></button>
      <button onclick="openModal('assets/academy-brochure.png')"><img src="assets/academy-brochure.png" alt="JCA four-page brochure"></button>
      <button onclick="openModal('assets/admission-poster.jpg')"><img src="assets/admission-poster.jpg" alt="JCA admission poster"></button>
    </div>
  </div>
</section>
...
<section class="section contact" id="contact">
  <div class="container">
    <div class="section-head"><div class="kicker">Contact</div><h2>Start Your Commerce Journey With JCA</h2><p>Morning batches are available for 11th & 12th Commerce and evening batches for B.Com students.</p></div>
    <div class="contact-grid">
      <div class="contact-card">
        <div class="contact-item"><div class="ci">📍</div><div><h4>Academy Address</h4><p>Joshi’s Commerce Academy, Shreeram Hanuman Mandir, Pawan Nagar, Pipeline Road, Bhistabag Chouwk, Savedi, Ahilyanagar 414003</p></div></div>
        <div class="contact-item"><div class="ci">📞</div><div><h4>Call / WhatsApp</h4><a href="tel:+917350476625">7350476625</a></div></div>
        <div class="contact-item"><div class="ci">✉️</div><div><h4>Email</h4><a href="mailto:joshiscommerceacademy@gmail.com">joshiscommerceacademy@gmail.com</a></div></div>
        <div class="socials">
          <a class="btn btn-dark" href="https://www.instagram.com/joshis_commerce_academy/" target="_blank">Instagram</a>
          <a class="btn btn-primary" href="https://wa.me/917350476625" target="_blank">WhatsApp</a>
        </div>
      </div>
      <div class="contact-card">
        <h3 style="color:var(--navy);font-size:25px;margin-bottom:10px">📍 Find JCA on Google Maps</h3>
        <p style="color:var(--muted);margin-bottom:22px">Open the academy location directly in Google Maps for directions.</p>
        <a class="btn btn-primary" href="https://share.google/1UZzvmtrcgGQbKiLz" target="_blank">Open Google Maps →</a>
        <div style="margin-top:30px;padding:22px;border-radius:18px;background:#eef3ff">
          <b style="color:var(--navy)">Batches</b>
          <p style="color:#667085;margin-top:6px">Morning: 11th & 12th Commerce<br>Evening: FY / SY / TY B.Com</p>
        </div>
      </div>
    </div>
  </div>
...
<a class="whatsapp" href="https://wa.me/917350476625" target="_blank" aria-label="WhatsApp">◉</a>

<footer>
  <div class="container">
    <div class="footer-grid">
      <div><h3>JOSHI'S COMMERCE ACADEMY</h3><p>Build Knowledge. Gain Confidence. Achieve Success.</p><p style="margin-top:10px">Where Education Meets Personal Attention.</p></div>
      <div><h3>Quick Links</h3><p><a href="#about">About JCA</a></p><p><a href="#courses">Courses</a></p><p><a href="#features">Why JCA</a></p><p><a href="#contact">Contact</a></p></div>
      <div><h3>Contact</h3><p><a href="tel:+917350476625">7350476625</a></p><p><a href="mailto:joshiscommerceacademy@gmail.com">Email JCA</a></p><p>Ahilyanagar 414003</p></div>
    </div>
    <div class="footer-bottom">© <span id="year"></span> Joshi’s Commerce Academy • All rights reserved.</div>
  </div>
</footer>

<div class="modal" id="modal" onclick="closeModal()">
  <button class="close" aria-label="Close">×</button>
  <img id="modalImg" src="" alt="Gallery preview" onclick="event.stopPropagation()">
</div>
<script>
